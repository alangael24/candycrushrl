...
class CandyCrush(pufferlib.PufferEnv):
    def __init__(
        ...
        task_min_steps=22,
        task_max_steps=40,
        task_hard_min_active_goals=3,
        task_hard_max_active_goals=3,
        task_hard_min_blocker_goals=1,
        task_mixed_hard_prob=0.35,
        task_hard_color_weight=1.0,
        task_hard_jelly_weight=1.0,
        task_hard_frosting_weight=2.5,
        task_hard_ingredient_weight=2.5,
        task_hard_score_weight=0.75,
        ...
        self.task_hard_min_active_goals = task_hard_min_active_goals
        self.task_hard_max_active_goals = task_hard_max_active_goals
        self.task_hard_min_blocker_goals = task_hard_min_blocker_goals
        self.task_mixed_hard_prob = task_mixed_hard_prob
        self.task_hard_color_weight = task_hard_color_weight
        self.task_hard_jelly_weight = task_hard_jelly_weight
        self.task_hard_frosting_weight = task_hard_frosting_weight
        self.task_hard_ingredient_weight = task_hard_ingredient_weight
        self.task_hard_score_weight = task_hard_score_weight
        ...
        self.c_envs = binding.vec_init(
            ...
            task_hard_min_active_goals=self.task_hard_min_active_goals,
            task_hard_max_active_goals=self.task_hard_max_active_goals,
            task_hard_min_blocker_goals=self.task_hard_min_blocker_goals,
            task_mixed_hard_prob=self.task_mixed_hard_prob,
            task_hard_color_weight=self.task_hard_color_weight,
            task_hard_jelly_weight=self.task_hard_jelly_weight,
            task_hard_frosting_weight=self.task_hard_frosting_weight,
            task_hard_ingredient_weight=self.task_hard_ingredient_weight,
            task_hard_score_weight=self.task_hard_score_weight,
