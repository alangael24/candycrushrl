...
class CandyCrush(pufferlib.PufferEnv):
    def __init__(
        ...
        task_min_steps=22,
        task_max_steps=40,
        task_family_sampling_mode=0,
        task_min_blocker_goals=0,
        task_color_weight=1.0,
        task_jelly_weight=1.0,
        task_frosting_weight=1.0,
        task_ingredient_weight=1.0,
        task_score_weight=1.0,
        ...
        self.task_family_sampling_mode = task_family_sampling_mode
        self.task_min_blocker_goals = task_min_blocker_goals
        self.task_color_weight = task_color_weight
        self.task_jelly_weight = task_jelly_weight
        self.task_frosting_weight = task_frosting_weight
        self.task_ingredient_weight = task_ingredient_weight
        self.task_score_weight = task_score_weight
        ...
        self.c_envs = binding.vec_init(
            ...
            task_family_sampling_mode=self.task_family_sampling_mode,
            task_min_blocker_goals=self.task_min_blocker_goals,
            task_color_weight=self.task_color_weight,
            task_jelly_weight=self.task_jelly_weight,
            task_frosting_weight=self.task_frosting_weight,
            task_ingredient_weight=self.task_ingredient_weight,
